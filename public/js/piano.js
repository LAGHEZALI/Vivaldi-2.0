...
function PianoController () {
    ...
    this.nextNote = function() {
        ...
        if( this.mode=="tuto" && this.monTuto.iter == this.monTuto.nbNotes) {
            ...
            $( '#btn-modal' ).click ();
             new Audio("/assets/sound/clap.mp3").play();
        }
        else {
    ...
    this.pressPianoBtn = function (buttonId,who) {
       
        notePressed(buttonId,oPianoSimple,who);
        ...
        setTimeout(function () {
            ...
            noteReleased(buttonId,"Cliquez ici pour Jouer avec le Clavier","#a62639","#CCC",who);

        }, 500);
    };

    this.pressPianoKey = function (event,who) {
        ...
        if(buttonId != "invalid") {
            ...
            setTimeout(function () {
                ...
                noteReleased(buttonId,"Tapez les touches AZERTYU pour Jouer","#85ff9e","#555",who)
...
function notePressed(buttonId,oPianoSimple,who) {
        ...
        if(who=="you") {
             $("#you").removeClass("bg-success");
            $("#you").addClass("bg-warning");
        }
        else if(who=="someone") {
             $("#someone").removeClass("bg-success");
            $("#someone").addClass("bg-warning");
        }
...
function noteReleased(buttonId,msg,bg,fg,who) {
        ...
        if(who=="you") {
            $("#you").removeClass("bg-warning");
            $("#you").addClass("bg-success");
        }
        else if(who=="someone") {
            $("#someone").removeClass("bg-warning");
            $("#someone").addClass("bg-success");
        }
        $("#pianoInput").val(msg);
}
